...
<body>
    ...
    <main class="dashboard-container-v4">
        <div class="welcome-banner"><div class="welcome-content"><div class="welcome-text"><h1>Your <span style="color: #fbbf24;">Trusted Partner</span> for Home Services</h1><p>Connect with <?php echo number_format((int)$stats['total_workers']); ?>+ verified local professionals. From plumbing to cleaning, we've got you covered.</p><?php if ((int)$trust_metrics['customer_satisfaction'] > 0): ?><div style="margin-top: 1rem;"><span class="trust-badge"><i class="fas fa-shield-alt"></i> <?php echo htmlspecialchars($trust_metrics['customer_satisfaction']); ?>% Customer Satisfaction</span></div><?php endif; ?></div><a href="/dailyfix/signup.php" class="btn-primary-v4"><i class="fas fa-user-plus"></i> <span>Get Started Now</span></a></div></div>
        <div class="stats-grid-v4 reveal"><div class="stat-card-v4 stat-success"><div class="stat-icon"><i class="fas fa-users"></i></div><div class="stat-info"><span class="stat-label">Happy Customers</span><span class="stat-value loading" data-target="<?php echo (int)$stats['total_customers']; ?>">0</span><span class="stat-desc">+<?php echo (int)$stats['new_customers_month']; ?> this month</span></div></div><div class="stat-card-v4 stat-primary"><div class="stat-icon"><i class="fas fa-user-tie"></i></div><div class="stat-info"><span class="stat-label">Verified Workers</span><span class="stat-value loading" data-target="<?php echo (int)$stats['total_workers']; ?>">0</span></div></div><div class="stat-card-v4 stat-danger"><div class="stat-icon"><i class="fas fa-concierge-bell"></i></div><div class="stat-info"><span class="stat-label">Total Bookings</span><span class="stat-value loading" data-target="<?php echo (int)$stats['completed_bookings']; ?>">0</span><span class="stat-desc"><?php echo (int)$stats['bookings_today']; ?> booked today</span></div></div><div class="stat-card-v4 stat-warning"><div class="stat-icon"><i class="fas fa-star"></i></div><div class="stat-info"><span class="stat-label">Average Review</span><span class="stat-value loading" data-target="<?php echo htmlspecialchars($stats['average_review']); ?>">0.0</span><span class="stat-desc">From <?php echo number_format((int)$stats['total_reviews']); ?> reviews</span></div></div></div>
