...
<head>
  ...
  .skeleton-title { height: 32px; width: 300px; margin-bottom: 1rem; }
  .skeleton-line { height: 16px; margin-bottom: 1rem; border-radius: 4px; }
  .skeleton-grid-3col { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; margin-top: 2rem; }
  .skeleton-card { height: 150px; }
  @media (max-width: 768px) { .skeleton-grid-3col { grid-template-columns: 1fr; } }
</style>
</head>
